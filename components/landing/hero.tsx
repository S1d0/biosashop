                ...
                <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                    <div className="flex flex-col justify-center space-y-4">
                        <div className="space-y-2">
                            ...
                            Naturalne <span className={"text-primary"}>Rozwiązania</span> dla zdrowszej planety
                            </h1>
                        ...
                        <div className="flex flex-col gap-2 min-[400px]:flex-row">
                            <Button asChild variant="outline" className={"bg-primary text-primary-foreground text-stone-50 font-bold tracking-wide"}>
                                <Link
                                    href="#products">
                                    Kup Teraz
                                </Link>
